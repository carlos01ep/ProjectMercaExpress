...
<div class="container mt-3">
      ...
      <div class="mb-3 mt-3">
        ...
        <input type="text" class="form-control" required pattern="[0-9]{16}" name="tramitar">
            </div>
            <div class="input-group mb-3">
            ...
            <span class="input-group-text">Código de seguridad/CVV2</span>
             ...
             <div class="input-group mb-3">
             <span class="input-group-text">Tirular de la tarjeta</span>
             <input type="text" class="form-control" required pattern="[a-zA-Z]{0-30}">
                 </div>
