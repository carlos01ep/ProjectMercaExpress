						...
						<div class="header__top__right">
							...
							if (sesion.getAttribute("email") == null) {
								...
								if (sesion.getAttribute("cuentatemporal") != null) {
									...
									sesion.setAttribute("cuentatemporal", IDtemp);
									//insertar ususario temporal
									Usuario usuario = new Usuario(IDtemp, "null", "null", "null", "null", "null", "null");
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-9 col-md-7">
					<div class="product__discount"></div>
					<div class="row">

						<%
						String productobuscar = (String) sesion.getAttribute("sNombre");
						sesion.removeAttribute("sNombre");
						LinkedList<Productos> lista = Controller.getAllProductos();
						for (int i = 0; i < lista.size(); i++) {
							...
							+ "<li><form action=\"ServletForm\" method=\"POST\"><input class=\"btn btn-success fa fa-shopping-cart\" type=\"submit\" id=\"idProducto2\" name=\"idProducto2\" value=\"🛒\"><br> <input type='hidden' name='idProducto' value='"
							+ i + "'></form></li>\r\n" + "</ul>\r\n" + "</div>\r\n"

							+ "<div class=\"product__item__text\">\r\n");
							out.println("<h6>" + lista.get(i).getNombre_pro() + "</h6>");
							out.println("<h5>" + lista.get(i).getPrecio() + " €</h5>");
							// 							out.println("<input type='hidden' name='idProducto' value='"+i+"'>");
							out.println("<br>");
							out.println("</div>\r\n" + "</div>\r\n" + "</div>\r\n");
						}
						%>
